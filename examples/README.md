...
- The New Zealand workflow prefers the official `api.legislation.govt.nz` API for discovery. Without an API key it can still fall back to the older scraper path, but that fallback is provisional.
